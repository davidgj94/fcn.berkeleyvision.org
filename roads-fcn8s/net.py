...
def conv_relu(bottom, nout, ks=3, stride=1, pad=1, k_wh=None, pad_wh=None):
    
    if k_wh and pad_wh:
        conv = L.Convolution(bottom, kernel_w=k_wh[0], kernel_h=k_wh[1], pad_w=pad_wh[0], pad_h=pad_wh[1], stride=stride,
                             num_output=nout,param=[dict(lr_mult=1, decay_mult=1), dict(lr_mult=2, decay_mult=0)])
    else:
...
def fcn_roads(split, batch_size):
    ...
    # the base net
    n.conv1_1, n.relu1_1 = conv_relu(n.data, 64, k_wh=(1, 7), pad_wh=(0, 3))
    n.conv1_2, n.relu1_2 = conv_relu(n.relu1_1, 64, k_wh=(1, 7), pad_wh=(0, 3))
    n.pool1 = max_pool(n.relu1_2)

    n.conv2_1, n.relu2_1 = conv_relu(n.pool1, 128, k_wh=(1, 7), pad_wh=(0, 3))
    n.conv2_2, n.relu2_2 = conv_relu(n.relu2_1, 128, k_wh=(1, 7), pad_wh=(0, 3))
    n.pool2 = max_pool(n.relu2_2)

    n.conv3_1, n.relu3_1 = conv_relu(n.pool2, 256, k_wh=(1, 7), pad_wh=(0, 3))
    n.conv3_2, n.relu3_2 = conv_relu(n.relu3_1, 256, k_wh=(1, 7), pad_wh=(0, 3))
    n.conv3_3, n.relu3_3 = conv_relu(n.relu3_2, 256, k_wh=(1, 7), pad_wh=(0, 3))
    n.pool3 = max_pool(n.relu3_3)

    n.conv4_1, n.relu4_1 = conv_relu(n.pool3, 512, k_wh=(1, 7), pad_wh=(0, 3))
    n.conv4_2, n.relu4_2 = conv_relu(n.relu4_1, 512, k_wh=(1, 7), pad_wh=(0, 3))
    n.conv4_3, n.relu4_3 = conv_relu(n.relu4_2, 512, k_wh=(1, 7), pad_wh=(0, 3))
    n.pool4 = max_pool(n.relu4_3)

    n.conv5_1, n.relu5_1 = conv_relu(n.pool4, 512, k_wh=(1, 7), pad_wh=(0, 3))
    n.conv5_2, n.relu5_2 = conv_relu(n.relu5_1, 512, k_wh=(1, 7), pad_wh=(0, 3))
    n.conv5_3, n.relu5_3 = conv_relu(n.relu5_2, 512, k_wh=(1, 7), pad_wh=(0, 3))
